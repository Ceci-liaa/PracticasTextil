    ...
    <div class="row align-items-center justify-content-lg-between ">
        <div class="col-lg-6 mb-lg-0 mb-4">
            <div class="copyright text-center text-m text-muted text-lg-start">
                ...
                <a href="https://www.utn.edu.ec/" class="text-secondary text-bold" target="_blank">Universidad Técnica del Norte</a> &
                <a href="https://software.utn.edu.ec/" class="text-secondary text-bold" target="_blank">Carrera Software</a>
                for a better web.
            </div>
        </div>
        <div class="col-lg-6">
